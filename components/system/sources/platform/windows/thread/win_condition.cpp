...
condition_t WindowsThreadManager::CreateCondition ()
{
  ...
  {
    exception.touch ("syslib::WindowsThreadManager::CreateCondition");
    throw;
  }
}
...
void WindowsThreadManager::DestroyCondition (condition_t handle)
{
  ...
  {
    exception.touch ("syslib::WindowsThreadManager::DestroyCondition");
    throw;
  }
}

void WindowsThreadManager::WaitCondition (condition_t handle, mutex_t mutex_handle)
{
  try
  {
    if (!handle)
...
void WindowsThreadManager::NotifyCondition (condition_t handle, bool broadcast)
{
  ...
  {
    exception.touch ("syslib::WindowsThreadManager::WaitCondition(condition_t,size_t)");
    throw;
  }
}
