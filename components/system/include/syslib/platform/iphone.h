...
struct TouchDescription
{
  ...
  float   current_x;   //текущее положение пальца относительно окна (0 - у левой границы окна, 1 - у правой)
  float   current_y;   //текущее положение пальца относительно окна (0 - у верхней границы окна, 1 - у нижней)
  float   previous_x;  //предыдущее положение пальца относительно окна (0 - у левой границы окна, 1 - у правой)
  float   previous_y;  //предыдущее положение пальца относительно окна (0 - у верхней границы окна, 1 - у нижней)
