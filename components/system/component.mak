...
SYSTEMLIB.SOURCES.macosx.SOURCE_DIRS                := sources/platform/macosx
SYSTEMLIB.SOURCES.macosx.COMPILER_DEFINES           := NO_PTHREAD_SEMAPHORES
...
SYSTEMLIB.UTILS.WIN8_LAUNCHER.CER_FILE          := utils/win8_launcher/cert/cert.cer
