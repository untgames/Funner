...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    int  ViewportX         () { return viewport_x; }
    int  ViewportY         () { return viewport_y; }
...
///Генерация мипов
///////////////////////////////////////////////////////////////////////////////////////////////////
    virtual void GenerateMips (render::low_level::IDeviceContext&) {}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    void BindViewport (render::low_level::IDevice* device, render::low_level::IDeviceContext* context, int& viewport_offset_x, int& viewport_offset_y);

  private:
///////////////////////////////////////////////////////////////////////////////////////////////////
///Реализация визуализации
///////////////////////////////////////////////////////////////////////////////////////////////////
    virtual void DrawCore (render::low_level::IDevice* device, render::low_level::IDeviceContext* context) = 0;
