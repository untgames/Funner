#ifndef RENDER_DX11_DRIVER_COMPLEX_TESTS_SHARED_HEADER
#define RENDER_DX11_DRIVER_COMPLEX_TESTS_SHARED_HEADER
...
//    window.Show ();
    ...
    DriverManager::CreateSwapChainAndDevice ("DX11", adapter_mask, desc, init_string, swap_chain, device);
