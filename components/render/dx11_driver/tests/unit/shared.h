#ifndef RENDER_DX11_DRIVER_DEVICE_TESTS_SHARED_HEADER
#define RENDER_DX11_DRIVER_DEVICE_TESTS_SHARED_HEADER
...
/*
    Пюыєўхэшх ёьх∙хэш▀ яюы▀ т ёЄЁєъЄєЁх (рэрыюу offsetof, ъюьяшышЁєхь√щ схч яЁхфєяЁхцфхэшщ эр gcc)
*/
...
struct Test
{
  ...
  {
    window.SetTitle (L"DX11 test window");
    ...
    DriverManager::CreateSwapChainAndDevice ("DX11", "*", desc, init_string, swap_chain, device);    
