...
struct DriverCaps
{
  bool can_create_swap_chain_without_device; //возможность создания цепочки обмена без устройства
};
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    virtual void GetCaps (DriverCaps&) = 0;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    virtual ISwapChain* CreateSwapChain (IDevice* device, const SwapChainDesc& desc) = 0;

///////////////////////////////////////////////////////////////////////////////////////////////////
///Создание устройства отрисовки
///////////////////////////////////////////////////////////////////////////////////////////////////
    virtual IDevice* CreateDevice (ISwapChain* swap_chain, const char* init_string = "") = 0;
    virtual IDevice* CreateDevice (size_t prefered_adapters_count, IAdapter** prefered_adapters, const char* init_string = "") = 0;
