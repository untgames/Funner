...
///////////////////////////////////////////////////////////////////////////////////////////////////
  unsigned int max_3d_texture_size;        //максимальный размер 3d текстуры
  unsigned int max_anisotropy;             //максимально возможная степень анизотропии
  unsigned int max_cube_map_texture_size;  //максимальный размер cubemap текстуры
  unsigned int max_rectangle_texture_size; //максимальный размер текстуры со сторонами не степени 2 для устройства
  unsigned int max_texture_size;           //максимальный размер текстуры для устройства
  unsigned int texture_units_count;        //количество слотов мультитекстурирования
  unsigned int ffp_texture_units_count;    //количество слотов мультитекстурирования, поддерживаемых FFP
