    ...
    handle (0)
{
  ...
  try
  {
    ...
    if (glShaderSource) glShaderSource    (handle, 1, (const char**)&desc.source_code, (int*)&desc.source_code_size);
    else                glShaderSourceARB (handle, 1, (const char**)&desc.source_code, (int*)&desc.source_code_size);
