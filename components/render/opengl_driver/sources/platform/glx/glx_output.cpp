...
/*
    ќписание реализации устройства вывода
*/
...
void Output::SetCurrentMode (const OutputModeDesc& mode_desc)
{
  ...
  // получение текущего разрешени€ и ориентации экрана
  ...
  // поиск запрашиваемого разрешени€ в списке доступных
  ...
  // получение всех доступных частот дл€ запрашиваемого разрешени€
  ...
  // глубина цвета окна указываетс€ при его создании и не может быть изменена
