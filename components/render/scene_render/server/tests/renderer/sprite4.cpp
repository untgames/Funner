...
void idle (Test& test)
{
  try
  {
    ...
    if (test.sprite)
    {
      ...
      test.sprite->DynamicShaderProperties ()->SetProperty ("dynamicParam", test.sprite->DynamicShaderProperties ()->GetFloat("dynamicParam") + 0.005f);
    }
...
int main ()
{
  ...
  try
  {
    ...
    sprite->SetMaterial ("sprite_dynamic_material");
    ...
    sprite->SetDynamicShaderProperties (&properties);
