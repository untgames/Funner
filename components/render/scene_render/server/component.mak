...
RENDER.SCENE_RENDER.SERVER.TESTS.SOURCE_DIRS := tests
RENDER.SCENE_RENDER.SERVER.TESTS.IMPORTS     := compile.render.scene_render.server link.render.scene_render.server
