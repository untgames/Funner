...
RENDER.SCENE_RENDER.INTERCHANGE.SOURCES.IMPORTS     := compile.render.scene_render.interchange compile.common compile.system compile.media.image compile.media.geometry
...
RENDER.SCENE_RENDER.INTERCHANGE.TESTS.IMPORTS     := compile.render.scene_render.interchange compile.media.image compile.media.geometry link.render.scene_render.interchange
