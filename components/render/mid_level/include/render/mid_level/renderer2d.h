...
///Фильтрация
///////////////////////////////////////////////////////////////////////////////////////////////////
    virtual void         SetMinFilter (TexMinFilter filter) = 0;
    virtual TexMinFilter GetMinFilter () = 0;

///////////////////////////////////////////////////////////////////////////////////////////////////
///Обновление текстуры
///////////////////////////////////////////////////////////////////////////////////////////////////
    virtual void Update (media::Image&) = 0;
};
...
enum ShaderMode
{
  ShaderMode_Normal,     //обычное наложение
  ShaderMode_Reflection, //отражение
  ShaderMode_AlphaClamp, //альфа-отсечение
...
///Режим шейдинга
///////////////////////////////////////////////////////////////////////////////////////////////////
    virtual void       SetShaderMode (ShaderMode mode) = 0;
    virtual ShaderMode GetShaderMode () = 0;
...
///Область отсечения
///////////////////////////////////////////////////////////////////////////////////////////////////
    virtual void SetScissor      (const Viewport&) = 0;
    virtual void SetScissorState (bool state) = 0;
    virtual void GetScissor      (Viewport&) = 0;
    virtual bool GetScissorState () = 0;
