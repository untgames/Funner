...
void Frame::SetRenderTargets (const render::mid_level::RenderTarget& render_target, const render::mid_level::RenderTarget& depth_stencil_target)
{
...
{
  return Wrappers::Wrap<render::mid_level::RenderTarget> (impl->DepthStencilTarget ());
}
