...
///////////////////////////////////////////////////////////////////////////////////////////////////
    render::obsolete::DrawTransactionManager& DrawTransactionManager (); //может быть равен 0
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    void RegisterRenderTarget   (render::obsolete::RenderTargetImpl*);
    void UnregisterRenderTarget (render::obsolete::RenderTargetImpl*);
...
///Менеджер рендеринга
///////////////////////////////////////////////////////////////////////////////////////////////////
    void                   SetRenderManager (render::obsolete::RenderManager*);
    render::obsolete::RenderManager* RenderManager    ();
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    const scene_graph::Rect& RenderableArea    ();
    void        SetRenderableArea (const scene_graph::Rect&);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    RenderableViewport  (const scene_graph::Viewport& viewport,
