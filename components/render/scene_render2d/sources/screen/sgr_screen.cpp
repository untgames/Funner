...
struct Screen::Impl: public xtl::reference_counter
{
  ...
  void AttachViewportNotify (render::obsolete::Viewport& viewport)
  {
    Notify (xtl::bind (&IScreenListener::OnAttachViewport, _1, xtl::ref (viewport)));
  }
  
  void DetachViewportNotify (render::obsolete::Viewport& viewport)
  {
...
void Screen::Attach (const render::obsolete::Viewport& viewport)
{
...
void Screen::Detach (const render::obsolete::Viewport& viewport)
{
  size_t viewport_id = viewport.Id ();
...
render::obsolete::Viewport& Screen::Viewport (size_t index)
{
...
const render::obsolete::Viewport& Screen::Viewport (size_t index) const
{
