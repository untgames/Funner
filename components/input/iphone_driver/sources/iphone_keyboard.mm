...
@interface TextFieldListener : NSObject <UITextFieldDelegate>
{
  @private
    ...
    NSString*         last_text;            //текст, содержащийся в строке во время последнего обновления
}
...
struct IPhoneKeyboard::Impl : public KeyboardListener
{
  ...
  TextFieldListener *text_field_listener;  //слушатель сообщений текстового поля
