...
SOUND.LOW_LEVEL_MEDIA_PLAYERS.SOURCES.IMPORTS     := compile.sound.low_level compile.media.players compile.media.sound compile.common
...
SOUND.LOW_LEVEL_MEDIA_PLAYERS.TESTS.IMPORTS     := compile.media.players link.sound.low_level_media_players compile.system \
                                                   link.sound.low_level_media_players_openal run.sound.low_level_media_players_openal \
