...
///////////////////////////////////////////////////////////////////////////////////////////////////
template <class Key>
const typename basic_spline<Key>::time_type& get_min_time (const basic_spline<Key>&);

template <class Key>
const typename basic_spline<Key>::time_type& get_max_time (const basic_spline<Key>&);
