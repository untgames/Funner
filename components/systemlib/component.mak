...
SYSTEMLIB_SOURCES.INCLUDE_DIRS     := include ../commonlib/include ../xtl/include sources
...
SYSTEMLIB_TESTS.INCLUDE_DIRS     := include ../commonlib/include ../xtl/include
SYSTEMLIB_TESTS.SOURCE_DIRS      := tests/wrappers
SYSTEMLIB_TESTS.LIB_DIRS         :=
SYSTEMLIB_TESTS.EXECTUTION_DIR   :=
SYSTEMLIB_TESTS.LIBS             := system commonlib user32
