...
///////////////////////////////////////////////////////////////////////////////////////////////////
///Исключение: ошибка приведения аргумента
///////////////////////////////////////////////////////////////////////////////////////////////////
class bad_argument_cast: public std::exception
{
  public:
    const char* what () const throw () { return "script::bad_argument_cast"; }
};
...
///////////////////////////////////////////////////////////////////////////////////////////////////
template <class Signature, class Fn> Invoker make_overload (Fn fn);
template <class Fn>                  Invoker make_overload (Fn fn);
