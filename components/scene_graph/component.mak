...
SG_COMPONENTS.INCLUDE_DIRS     := include ../boundvolumes/include
...
SG_COMPONENTS.IMPORTS          := ../common.static.mak  

#Цель №2 - SG tests
SG_TESTS.TYPE             := test-suite
SG_TESTS.INCLUDE_DIRS     := include ../boundvolumes/include
SG_TESTS.SOURCE_DIRS      := tests/core
SG_TESTS.LIB_DIRS         :=
SG_TESTS.LIBS             := sg
SG_TESTS.COMPILER_CFLAGS  :=
SG_TESTS.COMPILER_DEFINES := 
SG_TESTS.IMPORTS          := ../common.static.mak  
