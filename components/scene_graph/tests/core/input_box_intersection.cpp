...
int main ()
{
  ...
  InputZoneBox::Pointer zone (InputZoneBox::Create ());
  
  check (*zone, NodeTransformSpace_World, math::vec3f (0.0f, 0.0f, -1.0f), math::vec3f (0.0f, 0.0f, 1.0f));
  check (*zone, NodeTransformSpace_World, math::vec3f (0.0f, -1.0f, 0.0f), math::vec3f (0.0f, 1.0f, 0.0f));
  check (*zone, NodeTransformSpace_World, math::vec3f (-1.0f, 0.0f, 0.0f), math::vec3f (1.0f, 0.0f, 0.0f));
  check (*zone, NodeTransformSpace_World, math::vec3f (0.0f, 0.0f, 1.0f), math::vec3f (0.0f, 0.0f, -1.0f));
  check (*zone, NodeTransformSpace_World, math::vec3f (0.0f, 1.0f, 0.0f), math::vec3f (0.0f, -1.0f, 0.0f));
  check (*zone, NodeTransformSpace_World, math::vec3f (1.0f, 0.0f, 0.0f), math::vec3f (-1.0f, 0.0f, 0.0f));
  check (*zone, NodeTransformSpace_World, math::vec3f (0.0f, 0.9f, 0.0f), math::vec3f (1.0f, -1.0f, 0.0f));
  check (*zone, NodeTransformSpace_World, math::vec3f (0.0f, 1.1f, 0.0f), math::vec3f (1.0f, -1.0f, 0.0f));
