...
SDKS.FUNNER3D.IMPORTS       := compile.system compile.render.low_level compile.media.geometry compile.media.rfx \
                               compile.media.animation compile.media.image compile.media.video compile.physics.low_level \
                               compile.scene_graph.core compile.input.low_level compile.input.manager \
                               ...
                               link.input.manager.xkeymap link.input.manager.xkeyreg \
