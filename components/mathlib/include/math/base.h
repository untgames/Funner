...
///Основные операции
template <class T,size_t size> void vec_add (vec<T,size>& res,const vec<T,size>& a,const vec<T,size>& b);
template <class T,size_t size> void vec_sub (vec<T,size>& res,const vec<T,size>& a,const vec<T,size>& b);
template <class T,size_t size> void vec_mul (vec<T,size>& res,const vec<T,size>& a,const vec<T,size>& b);
template <class T,size_t size> void vec_div (vec<T,size>& res,const vec<T,size>& a,const vec<T,size>& b);

template <class T,size_t size> void vec_mul_scalar (vec<T,size>& res,const vec<T,size>& a,const T& b);
template <class T,size_t size> void vec_div_scalar (vec<T,size>& res,const vec<T,size>& a,const T& b);
