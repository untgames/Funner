...
const long MIN_DOWNLOAD_SPEED          = 100;  //Минимальная скорость закачки в байтах в секунду, при падении до которой закачка будет оборвана
const long MIN_DOWNLOAD_SPEED_DURATION = 30;   //Длительность закачки с минимальной скоростью, после которой будет выдана ошибка
