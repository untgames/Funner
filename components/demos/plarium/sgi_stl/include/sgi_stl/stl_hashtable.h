...
#include <sgi_stl/stl_vector.h>
#include <sgi_stl/stl_hash_fun.h>
...
#undef __HASH_ALLOC_INIT
  ...
  {
    __sgi_stl::swap(_M_hash, __ht._M_hash);
    __sgi_stl::swap(_M_equals, __ht._M_equals);
    __sgi_stl::swap(_M_get_key, __ht._M_get_key);
    _M_buckets.swap(__ht._M_buckets);
    __sgi_stl::swap(_M_num_elements, __ht._M_num_elements);
  }
