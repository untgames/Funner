...
//   operator templates (>, <=. >=, !=) in namespace sgi_stl::rel_ops, even
...
// a hook so that users can disable the sgi_stl::rel_ops namespace, keeping 
...
#   define __STL_USE_NAMESPACES
#   define __STD sgi_stl
#   define __STL_BEGIN_NAMESPACE namespace sgi_stl {
#   define __STL_END_NAMESPACE }
#   if defined(__STL_FUNCTION_TMPL_PARTIAL_ORDER) && \
       !defined(__STL_NO_RELOPS_NAMESPACE)
#     define __STL_USE_NAMESPACE_FOR_RELOPS
#     define __STL_BEGIN_RELOPS_NAMESPACE namespace sgi_stl { namespace rel_ops {
#     define __STL_END_RELOPS_NAMESPACE } }
#     define __STD_RELOPS sgi_stl::rel_ops
#   else /* Use sgi_stl::rel_ops namespace */
#     define __STL_USE_NAMESPACE_FOR_RELOPS
#     define __STL_BEGIN_RELOPS_NAMESPACE namespace sgi_stl {
#     define __STL_END_RELOPS_NAMESPACE }
#     define __STD_RELOPS sgi_stl
#   endif /* Use sgi_stl::rel_ops namespace */
# else
#   define __STD 
...
#   define __STD_QUALIFIER sgi_stl::
# else
#   define __STD_QUALIFIER
# endif
