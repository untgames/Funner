                             ...
                             _Rb_tree_node_base*& __rightmost)
{
  ...
  if (__y != __z) {          // relink y in place of z.  y is z's successor
    ...
    __sgi_stl::swap(__y->_M_color, __z->_M_color);
    __y = __z;
...
public:    
  ...
  void swap(_Rb_tree<_Key,_Value,_KeyOfValue,_Compare,_Alloc>& __t) {
    __sgi_stl::swap(_M_header, __t._M_header);
    __sgi_stl::swap(_M_node_count, __t._M_node_count);
    __sgi_stl::swap(_M_key_compare, __t._M_key_compare);
  }
