...
struct AesOfbContext::Impl
{
  ...
  {
    if (!key)
      throw std::invalid_argument ("AesOfbContext::AesOfbContext - null key");
    ...
    switch (key_bits)
    {
      ...
      case 256:
        ...
        break;
      default:
        throw std::invalid_argument ("AesOfbContext::AesOfbContext - unsupported key bits");
    }
  ...
  void Update (size_t data_size, const void* src_buffer, void* dst_buffer)
  {
    ...
    ofb128_encrypt ((const unsigned char*)src_buffer, (unsigned char*)dst_buffer, data_size, &aes_key, iv, &num);
  }
};
...
void aes_ofb (const void* key, size_t key_bits, size_t data_size, const void* src_buffer, void* dst_buffer, const unsigned char iv [16])
{
  ...
  ofb128_encrypt ((const unsigned char*)src_buffer, (unsigned char*)dst_buffer, data_size, &aes_key, iv_copy, &num);
}
