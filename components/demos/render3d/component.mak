...
DEMOS.RENDER3D.SOURCES.IMPORTS       := compile.system compile.render.low_level compile.media.geometry \
                                        compile.scene_graph.core link.common link.system link.render.low_level.opengl_driver \
                                        link.media.geometry.xmesh link.media.geometry link.scene_graph.core
