...
extern const char* SCENE_SPINE_SKELETON_LIBRARY;
...
void bind_controller_spine_animation_library                         (script::Environment&);
void bind_controller_spine_skeleton_visual_structure_builder_library (script::Environment&);
...
void bind_spine_skeleton_library                                     (script::Environment&);
