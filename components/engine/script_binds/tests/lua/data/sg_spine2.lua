...
function test ()
  local skeleton_data = Media.SpineSkeletonData.Create ("data/spine_3.8/goblins/export/goblins-pro.skel", "data/spine_3.8/goblins/export/goblins.atlas")
  ...
  local track = animation_state:EnqueueAnimation (0, skeleton_data:AnimationName (0), false, 0)
  
  print ("Default track mix blend = " .. track.MixBlend)
  print ("Default track hold previous = " .. tostring (track.HoldPrevious))
  
  track.MixBlend     = Media.SpineMixBlend.Add
  track.HoldPrevious = true
  
  print ("New track mix blend = " .. track.MixBlend)
  print ("New track hold previous = " .. tostring (track.HoldPrevious))
