...
MEDIALIB_COMPONENTS.SOURCE_DIRS      := sources/imagelib sources/soundlib sources/fontlib sources/geometry sources/rfx sources/soundsource
...
MEDIALIB_TESTS.SOURCE_DIRS      := tests/imagelib tests/soundlib tests/fontlib tests/geometry tests/rfx tests/soundsource
...
MEDIALIB_COLLADA.SOURCE_DIRS      := sources/collada/model sources/collada/dae_loader sources/collada/import
...
MEDIALIB_COLLADA_TESTS.LIBS             := commonlib zzip zlib collada medialib
