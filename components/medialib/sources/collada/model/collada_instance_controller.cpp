...
InstanceController::InstanceController (const InstanceController& ic, media::CloneMode mode)
  : impl (media::clone (ic.impl, mode, "media::collada::InstanceController::InstanceController"))
  {}
