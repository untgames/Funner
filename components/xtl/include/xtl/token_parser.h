...
bool read (const char* string, long long& result_value);
bool read (const char* string, unsigned long long& result_value);
...
bool read (const wchar_t* string, long long& result_value);
bool read (const wchar_t* string, unsigned long long& result_value);
