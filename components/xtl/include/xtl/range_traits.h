...
///////////////////////////////////////////////////////////////////////////////////////////////////
template <class T> typename range_reverse_iterator<T>::type rbegin (T&);       //получение обратного итератора на начало интервала
template <class T> typename range_reverse_iterator<T>::type rend   (T&);       //получение обратного итератора на конец интервала           
