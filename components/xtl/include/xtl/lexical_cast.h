...
/*
    ¬ отличие от boost, lexical_cast работает через двойное приведение source_type->stl::string->destination_type
*/
...
void to_string (stl::string& buffer, const volatile bool& value); //const volatile& дл€ избежани€ не€вного преобразовани€ к bool в xtl::any
