  ...
  public:
    wchar_string_converter (const wchar_t* string)
    {
      *buffer = '\0';
      ...
      static const size_t MAX_LENGTH = BUFFER_SIZE-1; //данный размер совпадает с количеством символов multibyte строке, поскольку работа производитс€ только с базовыми типами: числа и простые символы
