...
///////////////////////////////////////////////////////////////////////////////////////////////////
///Режим слежения за событиями переменных
///////////////////////////////////////////////////////////////////////////////////////////////////
enum VarRegistryWatchMode
{
  VarRegistryWatchMode_Recursive,    //отслеживаются события данного реестра и всех реестров в дочерних ветках
  VarRegistryWatchMode_NonRecursive, //отслеживаются только события данного реестра

  VarRegistryWatchMode_Num,

  VarRegistryWatchMode_Default = VarRegistryWatchMode_NonRecursive
};
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void EnumerateVars (const char* mask, const EnumHandler& handler);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    xtl::connection RegisterEventHandler (const char* var_name_mask, VarRegistryEvent event, VarRegistryWatchMode watch_mode, const EventHandler& handler) const;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    void Swap (const StringRegistry& source);
