...
class IPropertySetter
{
  public:
    ...
    virtual void Update (const PropertyMap& source, size_t property_index) = 0;
};

///////////////////////////////////////////////////////////////////////////////////////////////////
///Интерфейс получения свойства
///////////////////////////////////////////////////////////////////////////////////////////////////
class IPropertyGetter
{
  public:
    ...
    virtual void Update (PropertyMap& target, const char* property_name) = 0;
    virtual void Update (PropertyMap& target, size_t property_index) = 0;
};
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    PropertyBindings  ();
    PropertyBindings  (const PropertyLayout&);
    PropertyBindings  (const PropertyBindings&);
    ~PropertyBindings ();

    PropertyBindings& operator = (const PropertyBindings&);
...
///Связывание свойств
///////////////////////////////////////////////////////////////////////////////////////////////////
    void BindProperty   (const char* name, IPropertyGetter* getter);
    void BindProperty   (const char* name, IPropertySetter* setter);
    void UnbindProperty (const char* name);
    void Clear          ();
...
///Обмен
///////////////////////////////////////////////////////////////////////////////////////////////////
void swap (PropertyBindings&, PropertyBindings&);
