...
///////////////////////////////////////////////////////////////////////////////////////////////////
///ќписание потокового файла стандартной библиотеки
///////////////////////////////////////////////////////////////////////////////////////////////////
struct StdioFile
{
  const char* name;     //им€ в StdioIOSystem
  const char* dir_name; //им€ каталога
  FILE*       stream;   //поток
  filemode_t  mode;     //режим работы
};

///////////////////////////////////////////////////////////////////////////////////////////////////
///ѕотоковые файлы стандартной библиотеки
///////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////
/// оличество потоковых файлов стандартной библиотеки
//////////////////////////////////////////////,/////////////////////////////////////////////////////
...
//проверка существовани€ файла в домене
...
size_t StdioIOSystem::FileWrite (file_t file,const void* buf,size_t size)
{
  ...
  {
    if (printf ("%c", ((char*)buf) [i]) < 1) //llvm на Mac возвращает значени€ больше 1
