...
const unsigned int crc_tableil8_o40[256] =
{
...
const unsigned int crc_tableil8_o48[256] =
{
...
const unsigned int crc_tableil8_o56[256] =
{
...
const unsigned int crc_tableil8_o64[256] =
{
...
const unsigned int crc_tableil8_o72[256] =
{
...
const unsigned int crc_tableil8_o80[256] =
{
...
static const unsigned int crc_tableil8_o88[256] =
{
...
size_t crc32 (const void* data, size_t data_size, size_t crc)
{
  ...
  data_size -= initial_bytes;

  if (data_size < 64)
  {
    //slicing by 4
    size_t running_length = data_size & ~3;
    size_t end_bytes      = data_size - running_length;
    ...
    for (size_t li = 0; li < running_length/4; li++)
    {
      ...
      unsigned int term1 = crc_tableil8_o56[crc & 0x000000FF] ^ crc_tableil8_o48[(crc >> 8) & 0x000000FF];
      unsigned int term2 = crc >> 16;

      crc = term1 ^ crc_tableil8_o40[term2 & 0x000000FF] ^ crc_tableil8_o32[(term2 >> 8) & 0x000000FF];
    }
  ...
  {
    //slicing by 8
    size_t running_length = data_size & ~63;
    size_t end_bytes      = data_size - running_length;
    ...
    for (size_t li = 0; li < running_length / 8; li++)
    {
        ...
        unsigned int term1 = crc_tableil8_o88[crc & 0x000000FF] ^ crc_tableil8_o80[(crc >> 8) & 0x000000FF];
        unsigned int term2 = crc >> 16;

        crc = term1 ^ crc_tableil8_o72[term2 & 0x000000FF] ^ crc_tableil8_o64[(term2 >> 8) & 0x000000FF];
        term1 = crc_tableil8_o56[(*(unsigned int*)p_buf) & 0x000000FF] ^ crc_tableil8_o48[((*(unsigned int*)p_buf) >> 8) & 0x000000FF];
        term2 = (*(unsigned int*)p_buf) >> 16;
