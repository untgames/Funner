...
struct Sha256Context::Impl
{
  ...
  {
    if (!data && data_size)
      throw xtl::make_null_argument_exception ("common::Sha256Context::Update", "data");
  ...
  void Finish (unsigned char (&result_hash_value) [32])
  {
    if (!result_hash_value)
      throw xtl::make_null_argument_exception ("common::Sha256Context::Finish", "result_hash_value");
...
void CC_SHA256 (const void* data, size_t size, unsigned char result_hash_value [32])
{
  sha256_context ctx;
...
{
  if (!data && size)
    throw xtl::make_null_argument_exception ("common::sha256", "result_hash_value");
