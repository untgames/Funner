...
SCRIPTBINDS_COMPONENTS.INCLUDE_DIRS     := include ../script/include ../xtl/include ../commonlib/include ../mathlib/include
...
SCRIPTBINDS_TESTS.INCLUDE_DIRS     := include ../script/include ../commonlib/include ../xtl/include
SCRIPTBINDS_TESTS.SOURCE_DIRS      := tests/lua
SCRIPTBINDS_TESTS.LIB_DIRS         :=  
SCRIPTBINDS_TESTS.LIBS             := commonlib scriptbinds lua zzip zlib
