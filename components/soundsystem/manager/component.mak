...
SOUND_SYSTEM_SOURCES.INCLUDE_DIRS     := include ../lowlevel/include ../../commonlib/include ../../mathlib/include ../../xtl/include ../../systemlib/include ../../medialib/include
...
SOUND_SYSTEM_TESTS.INCLUDE_DIRS     := include ../lowlevel/include ../../commonlib/include ../../mathlib/include ../../xtl/include ../../systemlib/include ../openaldevice/include
SOUND_SYSTEM_TESTS.SOURCE_DIRS      := tests/manager
SOUND_SYSTEM_TESTS.LIB_DIRS         := ../../../extern/openalsdk/lib/win32
SOUND_SYSTEM_TESTS.LIBS             := commonlib soundlowlevel soundmanager system user32 openaldevice medialib zzip zlib vorbisfile_static vorbis_static ogg openal32
