...
enum BindFlag
{
  ...
  BindFlag_Texture      = 4,  //объект может быть присоединён как текстура
  BindFlag_RenderTarget = 8,  //объект может выступать в качестве целевого буфера отрисовки
  BindFlag_DepthStencil = 16, //объект может выступать в качестве dpeth-stencil буфера отрисовки
};
