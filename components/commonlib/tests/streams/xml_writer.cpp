...
int main ()
{
  ...
  try
  {
    ...
    writer.WriteAttribute  ("float", (float)M_PI);
    writer.WriteAttribute  ("double", (double)M_PI);
    writer.WriteAttribute  ("long_double", (long double)M_PI);
    ...
    writer.WriteNodeCData  ("quatd", quatd (M_PI));
    writer.EndNode         ();
