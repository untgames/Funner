...
///////////////////////////////////////////////////////////////////////////////////////////////////
///»нформаци€ о сообщении
///////////////////////////////////////////////////////////////////////////////////////////////////
struct ParseLogMessage
{
  ParseLogMessageType type;           //тип сообщени€  
  size_t              message_offset; //смещение до строки с сообщением
};

///////////////////////////////////////////////////////////////////////////////////////////////////
///ќписание реализации протокола парсера
///////////////////////////////////////////////////////////////////////////////////////////////////
struct ParseLog::Impl 
{
  ...
  ParseLogMessage* message_pos;     //позици€ дл€ записи следующего заголовка сообщени€
  char*            string_pos;      //позици€ дл€ записи следующей строки
  bool             has_errors;      //есть ошибки разбора
  bool             has_warnings;    //есть предупреждени€ разбора
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///–езервирование места под сообщение
///////////////////////////////////////////////////////////////////////////////////////////////////
