...
{
  if (!id)
    throw xtl::make_null_argument_exception ("media::collada::Camera::SetId", "id");
...
void Camera::SetType (CameraType type)
{
  switch (type)
  {
    ...
    case CameraType_Orthographic:
      break;
    default:
      throw xtl::make_argument_exception ("media::collada::Camera::SetType", "type", type);
      break;
  }
...
void Camera::SetParam (CameraParam param, float value)
{
  if (param < 0 || param >= CameraParam_Num)
    throw xtl::make_argument_exception ("media::collada::Camera::SetParam", "param", param);
...
{
  if (param < 0 || param >= CameraParam_Num)
    throw xtl::make_argument_exception ("media::collada::Camera::Param", "param", param);
