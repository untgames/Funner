...
int main ()
{
  try
  {
    printf ("Results of put_image_test:\n");
    ...
    image4.Save("results/put_image4 (PF convert and resize test).tga");

    image3.Save("results/put_image3.bmp");
    image2.Save("results/put_image2.bmp", PixelFormat_RGBA16);
    image2.Save("results/put_image2.jpg", PixelFormat_RGBA16);
    image2.Save("results/put_image2.tga", PixelFormat_RGBA8);

    Image new_image (204, 152, 1, image2.Format (), image2.Bitmap ());
    new_image.Save ("results/put_new_image.tga");

    image1.Save("results/put_image1.bmp", PixelFormat_RGBA8);

    image1.PutImage (10,10,0,170,170,10,image5,25,25,0);
    image1.Save("results/put_image1with5 (PutImage test).bmp", PixelFormat_RGB8);

    dump_hash ("results/put_image1with5 (PutImage test).bmp");
