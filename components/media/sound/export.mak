...
export.link.media.sound.default_decoders.LINK_INCLUDES := WavLoader OggLoader FlacLoader
export.link.media.sound.default_decoders.IMPORTS       := link.media.sound link.extern.vorbisfile link.extern.flac
