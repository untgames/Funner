...
OPENALDEVICE_TESTS.INCLUDE_DIRS     := include ../soundsystem/include ../commonlib/include ../mathlib/include ../xtl/include
OPENALDEVICE_TESTS.SOURCE_DIRS      := tests
OPENALDEVICE_TESTS.LIB_DIRS         := ../../extern/openalsdk/lib/win32
OPENALDEVICE_TESTS.LIBS             := openaldevice openal32 commonlib medialib zzip zlib vorbisfile_static vorbis_static ogg
