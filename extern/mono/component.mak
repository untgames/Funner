...
EXTERN.MONO.EGLIB.x86.COMPILER_DEFINES   := __i386__ TARGET_X86 i386 _M_IX86
...
EXTERN.MONO.EGLIB.g++.COMPILER_CFLAGS    := --no-warn
...
EXTERN.MONO.LIBGC.COMPILER_DEFINES       += PACKAGE_NAME="libgc-mono" PACKAGE_TARNAME="libgc-mono" PACKAGE_BUGREPORT="Hans_Boehm%40hp.com" GC_INSIDE_DLL=1 GC_NOT_DLL=1 JAVA_FINALIZATION=1 GC_GCJ_SUPPORT=1 ATOMIC_UNCOLLECTABLE=1 _IN_LIBGC=1 FD_SETSIZE=1024
EXTERN.MONO.LIBGC.COMPILER_DEFINES       += PACKAGE_VERSION="6.6"
EXTERN.MONO.LIBGC.COMPILER_DEFINES       += PACKAGE_STRING="libgc-mono 6.6"
EXTERN.MONO.LIBGC.x86.COMPILER_DEFINES   := __i386__ TARGET_X86 i386 _M_IX86
...
EXTERN.MONO.LIBGC.msvc.COMPILER_CFLAGS   := -D__STDC__ -wd4018 -wd4244 -wd4996 -wd4005 -wd4116 -wd4101 -wd4013 -wd4113 -wd4146 -wd4172
EXTERN.MONO.LIBGC.g++.COMPILER_CFLAGS    := --no-warn
...
EXTERN.MONO.LIBMONO.win32.DEF_FILE         := sources/mono.def
EXTERN.MONO.LIBMONO.x86.COMPILER_DEFINES   := TARGET_X86 __i386__ i386 _M_IX86
...
EXTERN.MONO.LIBMONO.g++.COMPILER_CFLAGS    := --no-warn
...
EXTERN.MONO_TESTS.LIBS              := funner.extern.mono.libmono
