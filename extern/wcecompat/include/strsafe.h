...
STRSAFEAPI StringCchCopyA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszSrc);
STRSAFEAPI StringCchCopyW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc);
#ifdef UNICODE
...
STRSAFEAPI StringCbCopyA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszSrc);
STRSAFEAPI StringCbCopyW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc);
#ifdef UNICODE
...
STDAPI
StringCchCopyEx(
    __out_ecount(cchDest) __opt LPTSTR  pszDest,
    __in  size_t  cchDest,
    IN  LPCTSTR pszSrc          OPTIONAL,
    __out __opt  LPTSTR* ppszDestEnd,
    __out __opt  size_t* pcchRemaining,
    IN  DWORD   dwFlags
    );
...
STRSAFEAPI StringCchCopyExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, const char* pszSrc, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
STRSAFEAPI StringCchCopyExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
STDAPI
StringCbCopyEx(
    __out_bcount(cbDest) __opt LPTSTR  pszDest,
    __in  size_t  cbDest,
    IN  LPCTSTR pszSrc          OPTIONAL,
    __out __opt LPTSTR* ppszDestEnd,
    __out __opt size_t* pcbRemaining,
    IN  DWORD   dwFlags
    );
...
STRSAFEAPI StringCbCopyExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, const char* pszSrc, __out __opt char** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
STRSAFEAPI StringCbCopyExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
STRSAFEAPI StringCchCopyNA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest, __in_ecount(cchSrc)  const char* pszSrc, __in size_t cchSrc);
STRSAFEAPI StringCchCopyNW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, __in_ecount(cchSrc)  const wchar_t* pszSrc, __in size_t cchSrc);
#ifdef UNICODE
...
STRSAFEAPI StringCbCopyNA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest, __in_bcount(cbSrc)  const char* pszSrc, __in size_t cbSrc);
STRSAFEAPI StringCbCopyNW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, __in_bcount(cbSrc)  const wchar_t* pszSrc, __in size_t cbSrc);
#ifdef UNICODE
...
StringCchCopyNEx(
    __out_ecount(cchDest) __opt LPTSTR  pszDest,
    __in  size_t  cchDest,
    __in_ecount(cchSrc) __opt  LPCTSTR pszSrc,
    __in  size_t  cchSrc,
    __out __opt LPTSTR* ppszDestEnd,
    __out __opt size_t* pcchRemaining,
    IN  DWORD   dwFlags
...
STRSAFEAPI StringCchCopyNExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, __in_ecount(cchSrc) __opt  const char* pszSrc, __in size_t cchSrc, __out __opt char** ppszDestEnd,
                             __out __opt size_t* pcchRemaining, unsigned long dwFlags);

STRSAFEAPI StringCchCopyNExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, __in_ecount(cchSrc) __opt  const wchar_t* pszSrc, __in size_t cchSrc, __out __opt wchar_t** ppszDestEnd,
                             __out __opt size_t* pcchRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
StringCbCopyNEx(
    __out_bcount(cbDest) __opt LPTSTR  pszDest,
    __in  size_t  cbDest,
    __in_bcount(cbSrc) __opt LPCTSTR pszSrc,
    __in  size_t  cbSrc,
    __out __opt LPTSTR* ppszDestEnd,
    __out __opt size_t* pcbRemaining,
    IN  DWORD   dwFlags
...
STRSAFEAPI StringCbCopyNExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, __in_bcount(cbSrc) __opt const char* pszSrc, __in size_t cbSrc, __out __opt char** ppszDestEnd,
                            __out __opt size_t* pcbRemaining, unsigned long dwFlags);
STRSAFEAPI StringCbCopyNExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, __in_bcount(cbSrc) __opt const wchar_t* pszSrc, __in size_t cbSrc, __out __opt wchar_t** ppszDestEnd,
                            __out __opt size_t* pcbRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
STRSAFEAPI StringCchCatA(__inout_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszSrc);
STRSAFEAPI StringCchCatW(__inout_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc);
#ifdef UNICODE
...
STRSAFEAPI StringCbCatA(__inout_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszSrc);
STRSAFEAPI StringCbCatW(__inout_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc);
#ifdef UNICODE
...
STDAPI
StringCchCatEx(
    __inout_ecount(cchDest) __opt LPTSTR  pszDest,
    __in     size_t  cchDest,
    IN     LPCTSTR pszSrc          OPTIONAL,
    __out __opt    LPTSTR* ppszDestEnd,
    __out __opt    size_t* pcchRemaining,
...
STRSAFEAPI StringCchCatExA(__inout_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, const char* pszSrc, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
STRSAFEAPI StringCchCatExW(__inout_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
STDAPI
StringCbCatEx(
    __inout_bcount(cbDest) __opt LPTSTR  pszDest,
    __in     size_t  cbDest,
    IN     LPCTSTR pszSrc          OPTIONAL,
    __out __opt    LPTSTR* ppszDestEnd,
    __out __opt    size_t* pcbRemaining,
...
STRSAFEAPI StringCbCatExA(__inout_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, const char* pszSrc, __out __opt  char** ppszDestEnd, __out __opt  size_t* pcbRemaining, unsigned long dwFlags);
STRSAFEAPI StringCbCatExW(__inout_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc, __out __opt  wchar_t** ppszDestEnd, __out __opt  size_t* pcbRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
STRSAFEAPI StringCchCatNA(__inout_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszSrc, size_t cchMaxAppend);
STRSAFEAPI StringCchCatNW(__inout_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc, size_t cchMaxAppend);
#ifdef UNICODE
...
STRSAFEAPI StringCbCatNA(__inout_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszSrc, size_t cbMaxAppend);
STRSAFEAPI StringCbCatNW(__inout_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc, size_t cbMaxAppend);
#ifdef UNICODE
...
STRSAFEAPI StringCchCatNExA(__inout_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, const char* pszSrc, size_t cchMaxAppend, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
STRSAFEAPI StringCchCatNExW(__inout_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszSrc, size_t cchMaxAppend, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
STRSAFEAPI StringCbCatNExA(__inout_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, const char* pszSrc, size_t cbMaxAppend, __out __opt char** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
STRSAFEAPI StringCbCatNExW(__inout_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszSrc, size_t cbMaxAppend, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
STRSAFEAPI StringCchVPrintfA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszFormat, va_list argList);
STRSAFEAPI StringCchVPrintfW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszFormat, va_list argList);
#ifdef UNICODE
...
STRSAFEAPI StringCbVPrintfA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszFormat, va_list argList);
STRSAFEAPI StringCbVPrintfW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszFormat, va_list argList);
#ifdef UNICODE
...
STRSAFEAPI StringCchPrintfA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest, const char* pszFormat, ...);
STRSAFEAPI StringCchPrintfW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest, const wchar_t* pszFormat, ...);
#ifdef UNICODE
...
STRSAFEAPI StringCbPrintfA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest, const char* pszFormat, ...);
STRSAFEAPI StringCbPrintfW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest, const wchar_t* pszFormat, ...);
#ifdef UNICODE
...
STRSAFEAPI StringCchPrintfExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags, const char* pszFormat, ...);
STRSAFEAPI StringCchPrintfExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags, const wchar_t* pszFormat, ...);
#ifdef UNICODE
...
STRSAFEAPI StringCbPrintfExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, __out __opt char** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags, const char* pszFormat, ...);
STRSAFEAPI StringCbPrintfExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags, const wchar_t* pszFormat, ...);
#ifdef UNICODE
...
STRSAFEAPI StringCchVPrintfExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, __out __opt char** ppszDestEnd, __out __opt  size_t* pcchRemaining, unsigned long dwFlags, const char* pszFormat, va_list argList);
STRSAFEAPI StringCchVPrintfExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags, const wchar_t* pszFormat, va_list argList);
#ifdef UNICODE
...
STRSAFEAPI StringCbVPrintfExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, __out __opt char** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags, const char* pszFormat, va_list argList);
STRSAFEAPI StringCbVPrintfExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags, const wchar_t* pszFormat, va_list argList);
#ifdef UNICODE
...
#ifdef STRSAFE_WITH_GETS
STRSAFE_INLINE_API StringCchGetsA(__out_ecount(cchDest) char* pszDest, __in size_t cchDest);
STRSAFE_INLINE_API StringCchGetsW(__out_ecount(cchDest) wchar_t* pszDest, __in size_t cchDest);
#ifdef UNICODE
...
#ifdef STRSAFE_WITH_GETS
STRSAFE_INLINE_API StringCbGetsA(__out_bcount(cbDest) char* pszDest, __in size_t cbDest);
STRSAFE_INLINE_API StringCbGetsW(__out_bcount(cbDest) wchar_t* pszDest, __in size_t cbDest);
#ifdef UNICODE
...
#ifdef STRSAFE_WITH_GETS
STRSAFE_INLINE_API StringCchGetsExA(__out_ecount(cchDest) __opt char* pszDest, __in size_t cchDest, __out __opt char** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
STRSAFE_INLINE_API StringCchGetsExW(__out_ecount(cchDest) __opt wchar_t* pszDest, __in size_t cchDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcchRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
#ifdef STRSAFE_WITH_GETS
STRSAFE_INLINE_API StringCbGetsExA(__out_bcount(cbDest) __opt char* pszDest, __in size_t cbDest, __out __opt char** ppszDestEnd, __out __opt size_t* pbRemaining, unsigned long dwFlags);
STRSAFE_INLINE_API StringCbGetsExW(__out_bcount(cbDest) __opt wchar_t* pszDest, __in size_t cbDest, __out __opt wchar_t** ppszDestEnd, __out __opt size_t* pcbRemaining, unsigned long dwFlags);
#ifdef UNICODE
...
STRSAFEAPI StringCchLengthA(__in_ecount(cchMax) const char* psz, __in size_t cchMax, __out __opt size_t* pcch);
STRSAFEAPI StringCchLengthW(__in_ecount(cchMax) const wchar_t* psz, __in size_t cchMax, __out __opt size_t* pcch);
#ifdef UNICODE
...
STRSAFEAPI StringCbLengthA(__in_bcount(cbMax) const char* psz, __in size_t cbMax, __out __opt size_t* pcch);
STRSAFEAPI StringCbLengthW(__in_bcount(cbMax) const wchar_t* psz, __in size_t cbMax, __out __opt size_t* pcch);
#ifdef UNICODE
