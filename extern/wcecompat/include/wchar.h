...
_inline _CRTIMP size_t __cdecl mbsrtowcs(wchar_t *wcstr, const char **mbstr, size_t count, mbstate_t *mbstate)
{
...
_inline _CRTIMP size_t __cdecl wcsrtombs(char *mbstr, const wchar_t **wcstr, size_t count, mbstate_t *mbstate)
{
