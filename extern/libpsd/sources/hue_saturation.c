...
psd_status psd_get_layer_hue_saturation(psd_context * context, psd_layer_record * layer)
{
	...
	// from ЁC100...100. The user interface represents hue as ЁC180...180,
	...
	for(i = 0; i < 6; i ++)
	{
		...
		// from ЁC60...60, however the slider will reflect each of the possible 201
		// values from ЁC100...100.
		for(j = 0; j < 4; j ++)
